...
2026-09-02, so ANY red, on any subject, is real.**
...
`catch_up_repeats_at` `0028` superseded), and re-pasting one of those alone reverts the pass while
reporting success.

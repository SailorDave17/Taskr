...
when `0018` was applied under #231. **Where it stands: the excused-red set is EMPTY, *measured* at
25 of 25 on 2026-08-27, so ANY red, on any subject, is real.**

[`docs/access-model.md`](docs/access-model.md) carries the excused-red table — empty as of the
`0018` application (#231) — and
the history of the thirteen times that set has been inverted, which is the

...
**Where it stands: the set is EMPTY again as of 2026-09-08, when #101 applied `0038` and deployed `calendar-events` in its own session — *measured* **62 of 65** immediately before `npm run migrate:live`, **64 of 65** after it, and **65 of 65** immediately after `npm run deploy:function`.**

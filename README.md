...
[`docs/access-model.md`](docs/access-model.md) carries the excused-red table — holding #430's three rows until `0042` is applied; before that, empty again since

...
#172 and the call arrives with #173. An entry then reddened `src/lib/liveSchema.test.js`, which holds both
...
*(True of the whole file until #172 listed the table; still true of the function until #173 calls it.)*

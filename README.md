...
`npm run probe:live-grants` agreeing from the catalog side. **Where it stands: the excused-red set
is EMPTY, *measured* at 26 of 26 on 2026-08-28, so ANY red, on any subject, is real.**

[`docs/access-model.md`](docs/access-model.md) carries the excused-red table — empty, `0020`'s row
having drained in #50's own session — and

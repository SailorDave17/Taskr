...
//    this is just to make sure I can commit
    ...
    public void run(String... args) throws Exception {
        ...
        TaskTemplate testTemplate = new TaskTemplate("Final Project Demo", 300, 300);

        taskTemplateStorage.save(testTemplate);
        TaskTemplate testTemplate1 = new TaskTemplate("Do the dishes", 20, 300);
...
//        taskTemplateStorage.addAllUsersToAllTaskTemplates();
        TaskTemplate testTemplate2 = new TaskTemplate("Wash a load of laundry", 300, 300);
        testTemplate2.setMinutesExpectedToComplete(120);
        testTemplate2.setActualWorkTime(20);
        TaskTemplate testTemplate3 = new TaskTemplate("Take out the trash", 300, 300);
        testTemplate3.setMinutesExpectedToComplete(5);
        TaskTemplate testTemplate4 = new TaskTemplate("Mow the lawn", 300, 300);
...
//        taskTemplateStorage.allocateTasks(taskTemplateIterable);
        ...
        testUser.updateUser();
        userStorage.save(testUser);
        TaskTemplate newTasktemplate01 = new TaskTemplate("Clean Common Area", 300, 300);
        TaskTemplate newTasktemplate02 = new TaskTemplate("Clean Garage", 300, 300);
        TaskTemplate newTasktemplate03 = new TaskTemplate("Clean Bathrooms", 300, 300);
        TaskTemplate newTasktemplate04 = new TaskTemplate("Take Out Trash", 300, 300);
        TaskTemplate newTasktemplate05 = new TaskTemplate("Wash Dishes", 300, 300);
        TaskTemplate newTasktemplate06 = new TaskTemplate("Wash/Dry Laundry", 300, 300);
        TaskTemplate newTasktemplate07 = new TaskTemplate("Fold/Put Away Laundry", 300, 300);
        TaskTemplate newTasktemplate08 = new TaskTemplate("Rake Leaves", 300, 300);
        TaskTemplate newTasktemplate09 = new TaskTemplate("Mow Lawn", 300, 300);
        TaskTemplate newTasktemplate10 = new TaskTemplate("Clean Bedroom", 300, 300);
        TaskTemplate newTasktemplate11 = new TaskTemplate("Deep Clean Kitchen", 300, 300);
        TaskTemplate newTasktemplate12 = new TaskTemplate("Tidy Kitchen", 300, 300);
        TaskTemplate newTasktemplate13 = new TaskTemplate("Vacuum Living Room", 300, 300);
        TaskTemplate newTasktemplate14 = new TaskTemplate("Mop/Sweep Kitchen", 300, 300);
        TaskTemplate newTasktemplate15 = new TaskTemplate("Change Litter Box", 300, 300);
        TaskTemplate newTasktemplate16 = new TaskTemplate("Walk Dog", 300, 300);
        TaskTemplate newTasktemplate17 = new TaskTemplate("Clean Up Yard", 300, 300);
        TaskTemplate newTasktemplate18 = new TaskTemplate("Get Mail", 300, 300);
        TaskTemplate newTasktemplate19 = new TaskTemplate("Dust Living Room", 300, 300);
        TaskTemplate newTasktemplate20 = new TaskTemplate("Dust Family Room", 300, 300);
        TaskTemplate newTasktemplate21 = new TaskTemplate("Vacuum Family Room", 300, 300);
        TaskTemplate newTasktemplate22 = new TaskTemplate("Dust Ceiling Fans", 300, 300);
        ...
        Task newTask2 = new Task(testUser, testTemplate2);
        Task newTask3 = new Task(testUser2, newTasktemplate22);
        Task newTask4 = new Task(testUser, testTemplate3);
        Task newTask5 = new Task(testUser, testTemplate1);
        Task newTask6 = new Task(testUser, testTemplate4);
        Task newTask7 = new Task(testUser, testTemplate1);

...
const displaySingleUserView = function(user) {
    ...
    userPageHeader.innerText = "Electric Boogaloo";
    // userPageHeader.innerText = `${user.name}'s Task List -${day}` //whatever day is being accessed by the user. default will be Sunday
    ...
    userNamePageElement.innerText = user.name;

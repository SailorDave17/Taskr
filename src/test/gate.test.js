...
describe('#19 — no real household name reaches version control', () => {
  ...
  const ALLOWED_ASSETS = {
    ...
    // #484 — not a manifest icon: iOS reads it from `index.html`'s
    // `apple-touch-icon` link and from nowhere else. Same generator, same
    // three-bar motif, no source art, so it carries no more of a household
    // than the three above.
    'public/icons/apple-touch-icon-180.png':
      'iOS home-screen icon, linked from index.html, generated by scripts/generate-icons.mjs',
  }

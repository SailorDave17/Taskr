// List a week of a member's calendar events — story #101. The platform binding, and nothing else.
//
...
//
// The split is not stylistic — `calendar-busy/index.ts` gives the argument, and
// it is the same one here: the subject is what Google does, so a suite needing
// a real Google is a suite that never runs.
